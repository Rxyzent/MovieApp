    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when(viewType){
            ...
            BaseType.TYPE_TopRated->{
                ...
                holder.binding.root.setOnClickListener {
                    onAllMovieItemClick?.invoke((data[position] as com.rxyzent.homework56.model.response.home.topRated.Result).id)
                }
            }
            BaseType.TYPE_Upcoming->{
                ...
                holder.binding.root.setOnClickListener {
                    onAllMovieItemClick?.invoke((data[position] as com.rxyzent.homework56.model.response.home.upcoming.Result).id)
                }
            }
        }
    }
