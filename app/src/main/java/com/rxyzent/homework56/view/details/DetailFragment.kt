package com.rxyzent.homework56.view.details
...
import coil.load
import com.rxyzent.homework56.adapter.detail.main.DetailAdapter
import com.rxyzent.homework56.databinding.DetailFragmentBinding
...
import com.rxyzent.homework56.presenter.impl.PresenterDetail
import com.rxyzent.homework56.presenter.interfaces.DetailPresenter
...
class DetailFragment :BaseFragment(),DetailPresenter.View{
    ...
    override fun showTrailers(trailers: List<com.rxyzent.homework56.model.response.details.trailer.Result>) {
